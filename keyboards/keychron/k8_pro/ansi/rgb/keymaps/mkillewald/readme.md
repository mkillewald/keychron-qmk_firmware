...
- All custom keycodes can be moved to different keys in VIA by using the ANY key with the following keycodes:
    - CUSTOM(0) (default: Fn+Z) Caps Lock light Tab toggle
    - CUSTOM(1) (default: Fn+X) Caps Lock light alphas toggle
    - CUSTOM(2) (default: Fn+C) Fn layer non-defined keys RGB toggle
    - CUSTOM(3) (default: Fn+V) Fn layer defined keys static color toggle
