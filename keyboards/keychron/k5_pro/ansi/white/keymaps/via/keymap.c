...
[MAC_BASE] = LAYOUT_ansi_108(
    KC_ESC,             KC_BRID,  KC_BRIU,  KC_MCTL,  KC_LNPD,  BL_DOWN,  BL_UP,    KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU, KC_SNAP,  KC_SIRI,  BL_STEP, KC_F13,  KC_F14,  KC_F15,  KC_F16,
