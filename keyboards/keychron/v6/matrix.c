...
#ifndef NO_PIN_NUM
#    define NO_PIN_NUM 8
#    ifndef MAX_NO_PIN_INDEX
#        define MAX_NO_PIN_INDEX 18
#    endif
#endif
...
static void shiftOut(uint16_t dataOut, bool singleFlag) {
    if (singleFlag) {
        if (dataOut & 0x1) {
...
#if defined(MAX_NO_PIN_INDEX)
    shiftOut(0x3FF, false);
#else
    shiftOut(0xFF, false);
#endif
}
